...
class ImageToTextModel:
    def __init__(self, config_path="config/config.yaml", use_finetuned=False):
        """
        Initializes the model by loading configuration, the base model,
        and optionally the fine-tuned adapter weights.
        """
    ...
    def generate_search_query(self, image: Image.Image, max_length: int = 50) -> str:
        """
        Generates a detailed and refined search query from a given image.
        """
    ...
    def _refine_search_query(self, raw_caption: str) -> str:
        """
        Refines a raw caption by removing common filler words to create a concise search query.
        """
